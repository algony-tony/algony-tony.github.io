...
Lister Plugins 是通过 TC 的 F3 来查看文件，可以配置对一些文件格式自动使用对应的插件，对应配置文件 ListerPlugins 子项，如下是我安装的八个查看插件的配置，也可以在查看器的 Plugins 菜单下手动选择。
...
4_detect="MULTIMEDIA"
5=%COMMANDER_PATH%\plugins\wlx\wlx_pdfview\pdfview.wlx
5_detect="ext="PDF" | ext="PS" | ext="EPS" | ([0]="%" & [1]="!" & [2]="P" & [3]="S") | ([0]="%" & [1]="P" & [2]="D" & [3]="F" & [4]="-")"
6=%COMMANDER_PATH%\plugins\wlx\wlx_csv_0_6_1\wlx_csv.wlx
6_detect="ext="CCCSV""
7=%Commander_Path%\plugins\wlx\MarkdownView\MarkdownView.wlx
7_detect="ext="MD""
```
