...
“机械图书馆是一个开源展览和课程，旨在向初中和高中学生介绍机械工程。 6英尺高的移动机械模型展品展示了重要或有趣的工程发明。每个机械装置都有一个网页， 解释了这些机制在现实生活中是如何运用的。它包含照片、视频、3D模型和乐高模型。”

* [万向节](https://mechanical-library.org/universal-joint)
* [直角齿轮](https://mechanical-library.org/gear-right-angle)